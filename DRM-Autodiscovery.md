...
DRM specs leave certain parts of the control flow undefined, especially as regards the initial setup of a patron's account, with the assumption that the bookstore will come up with something and hard-code it into its mobile app.
